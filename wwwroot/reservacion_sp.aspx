                        ...
                        <div>
                            <div class="fondoGrisReserva">
                                <div class="paddingReserva2">
                                    <asp:Panel ID="panel" runat="server" Visible="true">
                                        ...
                                        <asp:Panel ID="pnl_contenido" runat="server" Visible="true">
                                            ...
                                            <span class="terminosNuevo">
                                                ...
                                                <a href="#?w=620" rel="popup_code" class="poplight" id="old_terms" runat="server">&nbsp;T&eacute;rminos
                                    ...
                                    <br />
                                    <p class="link-chat">
                                        *Si tiene una duda o consulta no dude en contactarnos a través de nuestro <span class="colorRojo">
                                            <a href="javascript: $zopim.livechat.window.show();">CHAT</a></span><br />
                                        **Servicio sujeto a disponibilidad. El huesped debe contactar a hotel Manatus para
                                        definir el lugar donde se recoge y/o se deja antes de realizar la reservación.
                                        <br />
                                        <br />
                                        Costo por persona por traslado por vía: $75<br />
                                        <!--Costo por persona por traslado por vía 2015: $75</p><br />-->
                                </div>
                            </div>
                        </div>
