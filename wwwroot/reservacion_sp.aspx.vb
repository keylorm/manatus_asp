...
Partial Class reservacion_sp
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            If paquete = 2 Then
                ...
                hyplnk_paquetes.NavigateUrl = "Terminos_y_condiciones_Manatus_mayo_y_junio.pdf"
        ...
        txt_direccion.Attributes.Add("placeholder", "Dirección")
        txt_codArea.Attributes.Add("placeholder", "Código de Área")
        txt_tel.Attributes.Add("placeholder", "Teléfono")
        txt_email.Attributes.Add("placeholder", "Email")
        txtDateEntrada.Attributes.Add("placeholder", "Fecha de Entrada")
        txtDateSalida.Attributes.Add("placeholder", "Fecha de Salida")
        txt_pickup.Attributes.Add("placeholder", "Lugar donde se recoge")
        txt_leave.Attributes.Add("placeholder", "Lugar donde se deja")
        txt_observaciones.Attributes.Add("placeholder", "Observaciones")
    ...
    Protected Sub reservarconPaquete()
        If chkbox_terminos.Checked Then
                            ...
                            If total_de_noches > 0 Then
                                ...
                                If validarPrecios(id_temporada, id_producto, noches, gv_ResultadosDisponibles) Then
                                    ...
                                    If habitacionesDisponibles.Rows.Count >= habitacionesDeseadas Then
                                        ...
                                        descripcion &= "<br/><strong>Para lugar donde se recoge y donde se deja:</strong> El huesped debe contactar el hotel Manatus para definir el lugar donde se recoge y/o se deja."
                                        descripcion &= "<br /><br /><strong> NOCHE EXTRA GRATIS</strong><br />"
            ...
            Else
                ...
                lbl_erroFechas.Text &= "Noche Extra Gratis en Hotel Manatus es válida durante mayo y junio 2015.<br/>"
    ...
    '            ' lbl_erroFechas.Text = "Paquete v&aacute;lido para los meses de julio a octubre 2011<br/>"
    '        Else 'No viene del Boletin
    '            PromoIni = New Date(2011, 9, 1)
    '            PromoFin = New Date(2011, 10, 31)
    '            lbl_erroFechas.Text = "Paquete v&aacute;lido para los meses de septiembre a octubre 2011<br/>"
    '        End If
    ...
    '                                        Case 4
    '                                            descripcion &= "<br /><br /><strong> Paquete: TOUR DE ANIDACIÓN GRATIS, Disfrute de un tour de Tortugas, cortesía del hotel.</strong><br />"

    '                                        Case 6
    '                                            descripcion &= "<br /><br /><strong> Paquete: Free Fly.</strong><br />"
    ...
    '    Dim DateEntrada As Date = calendarEntrada.SelectedDate
    '    Dim DateSalida As Date = calendarEntrada.SelectedDate
    '    Dim PromoIni As New Date(2010, 9, 1)
    '    Dim PromoFin As New Date(2010, 11, 30)
    '    If DateEntrada >= PromoIni And DateSalida <= PromoFin Then
    '        If DateEntrada >= PromoIni And DateSalida <= PromoFin Then
    ...
    Protected Sub calendarEntrada_DateChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles calendarEntrada.DateChanged
        ...
        'min2014 = DateValue("2014/01/01")
        'max2014 = DateValue("2014/12/31")
        'paquete = 0
        If paquete = 2 Then
            ...
            'min = DateValue("2014/5/01") ' Abajo
            'max = DateValue("2014/6/27") ' Abajo
        ...
        'If calendarEntrada.SelectedDate >= min2014 And calendarEntrada.SelectedDate <= max2014 Then
        '    trPaquetes2014.Visible = True
