<%@ Page Language="VB" AutoEventWireup="false" CodeFile="reservacion_en_paso2.aspx.vb" Inherits="reservacion_en_paso2" %>
            ...
            <div class="content container-980">
                <div class="above-content">
                        ...
                        <div class="inner">
                            <div class="step-1">
                                <div class="step-title">
                                    <p><a href="reservacion_en_paso1.aspx">Availability</a></p>
                                </div>
                    ...
                    <div class="form-title">
                        <h2 class="h2Celeste">Please fill out your personal<br>information</h2>
                        <div class="logo-ssl">
                ...
                <div class="content-box container-2-3">
                    ...
                    <div class="alignLeft btn_toStep3">
                        <asp:LinkButton ID="btn_aPaso3" runat="server" ToolTip="Reservar" ValidationGroup="registrese" ForeColor="#FFFFFF" Visible="true">SEND INFORMATION AND CONTINUE TO STEP 3: PAYMENT DATA</asp:LinkButton>
                    </div>
                    <!-- end register form -->
                </div>
