...
Public Class Relacion_Producto_Entidad : Inherits DBTable
    ...
    Public Overrides Function CreateInstance(Optional ByVal forScripting As Boolean = False) As DBTable
        Dim theInstance As Relacion_Producto_Entidad
        If forScripting Then
            theInstance = NewForScripting()
        Else
            theInstance = New Relacion_Producto_Entidad
        End If
        Return theInstance
    End Function

    Shared Function NewForScripting() As Relacion_Producto_Entidad
        Dim temp As New Relacion_Producto_Entidad()
        temp.SetFields()
