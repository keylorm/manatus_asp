...
Public Class Relacion_Entidad_Producto : Inherits DBTable

    Dim _tableName As String = "RE_Entidad_Producto"
    ...
    Public Sub New(ByVal theid_entidad As String, ByVal theid_producto As String, ByVal theid_TipoRelacion As String)
    ...
    Protected Overrides Sub SetKeysForScripting()
        ...
        _foreingKeys.Add(New ForeingKey(id_TipoRelacion, New TipoRelacion_Entidad_Producto().Id_TipoRelacion))
    ...
    End Property
            ...
            Dim theInstance As Relacion_Entidad_Producto
            If forScripting Then
                theInstance = NewForScripting()
            Else
                theInstance = New Relacion_Entidad_Producto
            End If
            Return theInstance
        End Function

        Shared Function NewForScripting() As Relacion_Entidad_Producto
            Dim temp As New Relacion_Entidad_Producto()
            temp.SetFields()
