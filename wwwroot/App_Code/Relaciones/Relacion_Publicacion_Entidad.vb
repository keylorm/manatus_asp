...
Public Class Relacion_Publicacion_Entidad : Inherits DBTable
    ...
    End Property
        ...
        Dim theInstance As Relacion_Publicacion_Entidad
            If forScripting Then
                theInstance = NewForScripting()
            Else
            theInstance = New Relacion_Publicacion_Entidad
            End If
            Return theInstance
        End Function

    Shared Function NewForScripting() As Relacion_Publicacion_Entidad
        Dim temp As New Relacion_Publicacion_Entidad()
        temp.SetFields()
