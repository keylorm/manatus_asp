<%@ Page Language="VB" MasterPageFile="~/Orbecatalog/popUp.master" AutoEventWireup="false"
    CodeFile="Entidad_Producto.aspx.vb" Inherits="Orbecatalog_Relaciones_Entidad_Producto"
    Title="Orbe Catalog Entidad-Producto" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cph_Titulo" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cph_Contenido" runat="Server">
    <asp:UpdatePanel runat="server" UpdateMode="Conditional" ID="upd_panel">
        <ContentTemplate>
            <asp:Panel ID="pnl_Entidad_Producto" runat="server">
                <div class="Container_popUp">
                    <table cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td colspan="2">
                                <br />
                                <asp:Button ID="btn_Agregar" runat="server" Text="Agregar" Width="100px" /><br />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                        ...
                        <tr>
                            <td colspan="2">
                                <asp:ListBox ID="lst_Entidad_Producto" runat="server"></asp:ListBox>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
