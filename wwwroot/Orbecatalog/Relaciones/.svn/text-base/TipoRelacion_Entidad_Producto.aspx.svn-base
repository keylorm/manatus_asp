<%@ Page Language="VB" MasterPageFile="~/Orbecatalog/OrbeCatalog.master" AutoEventWireup="false"
    CodeFile="TipoRelacion_Entidad_Producto.aspx.vb" Inherits="Orbecatalog_Relaciones_TipoRelacion_Entidad_Producto"
    Title="Untitled Page" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cph_Titulo" runat="Server">
    <h1>
        Tipo de Relacion entre Entidades y Productos</h1>
</asp:Content>
        ...
        <ContentTemplate>
            <table class="Container" cellspacing="0" cellpadding="0" border="0">
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="tbx_NombreRelacion_Entidad_Productos" runat="server"></asp:TextBox>
                    </td>
                    <td>
                        <asp:RequiredFieldValidator ID="vld_tbx_Entidad_Producto" runat="server" ControlToValidate="tbx_NombreRelacion_Entidad_Productos"
                ...
                <tr>
                    <td>
                        Nombre Producto-Entidad
                    </td>
                    <td>
                        <asp:TextBox ID="tbx_NombreRelacion_Producto_Entidad" runat="server"></asp:TextBox>
                    </td>
                    <td>
                        <asp:RequiredFieldValidator ID="vld_tbx_Producto_Entidad" runat="server" ControlToValidate="tbx_NombreRelacion_Producto_Entidad"
                            Display="Dynamic" EnableClientScript="False" ErrorMessage="<%$ Resources:Orbecatalog_Resources, Campo_Requerido %>"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
