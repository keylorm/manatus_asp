<%@ Page Language="VB" MasterPageFile="~/Orbecatalog/popUp.master" AutoEventWireup="false"
    CodeFile="Entidad_Publicacion.aspx.vb" Inherits="Orbecatalog_Relaciones_Entidad_publicacion"
    Title="Orbe Catalog Entidad-Publicacion" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_Contenido" runat="Server">
    <asp:UpdatePanel runat="server" UpdateMode="Conditional" ID="upd_panel">
        <ContentTemplate>
            <asp:Panel ID="pnl_Entidad_Publicacion" runat="server">
                <div class="Container_popUp">
                    <table cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td colspan="2">
                                <asp:ListBox ID="lst_Entidad_Publicacion" runat="server"></asp:ListBox>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
