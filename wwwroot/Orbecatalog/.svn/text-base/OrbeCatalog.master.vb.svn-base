...
Partial Class _Orbecatalog_OrbeCatalog
    ...
    Protected Sub btn_Buscar_Clik(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_buscar.Click
        Buscar(Me.hf_codigo.Value, Me.tbx_Search.Text)
    End Sub
    ...
    Protected Sub btn_if_OK_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_if_OK.Click
        If elDelegado IsNot Nothing Then
            elDelegado.Invoke(Session("codigoPop"))
        End If
        Me.pop_Pnl_Acciones.Hide()
    End Sub
