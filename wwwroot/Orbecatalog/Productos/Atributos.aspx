<%@ Page Language="VB" MasterPageFile="../OrbeCatalog.master" AutoEventWireup="false"
    CodeFile="Atributos.aspx.vb" Inherits="_Atributos" Title="Orbe Catalog - Atributos" %>


<asp:Content ID="ctn_TituloSeccion" ContentPlaceHolderID="cph_Titulo" runat="Server">
    <asp:Literal runat="server" Text="<%$ Resources:Productos_Resources, Atributos_Pantalla %>" />
</asp:Content>
            ...
            <table class="Container" cellspacing="0" cellpadding="0" border="0">
                <tr>
                    <td>
                        Nombre</td>
                    <td>
                        <asp:TextBox ID="tbx_NombreAtributoProducto" runat="server"></asp:TextBox>&nbsp;</td>
                    <td>
                        <asp:RequiredFieldValidator ID="vld_tbx_NombreAtributoProducto" runat="server" ControlToValidate="tbx_NombreAtributoProducto"
                ...
                <asp:DataGrid ID="dg_Atributos" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="Atributo">
                            <ItemTemplate>
                                <asp:Label ID="lbl_NombreAtributoProducto" runat="server" Text="Label"></asp:Label>
                            </ItemTemplate>
                            <ItemStyle Width="55%" />
                        </asp:TemplateColumn>
