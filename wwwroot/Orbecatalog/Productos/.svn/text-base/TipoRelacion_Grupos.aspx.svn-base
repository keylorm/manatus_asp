<%@ Page Language="VB" MasterPageFile="~/Orbecatalog/OrbeCatalog.master" AutoEventWireup="false"
    CodeFile="TipoRelacion_Grupos.aspx.vb" Inherits="Orbecatalog_Productos_TipoRelacion_Grupos"
    Title="Untitled Page" %>

<asp:Content ID="ctn_TituloSeccion" ContentPlaceHolderID="cph_Titulo" runat="Server">
    <asp:Literal runat="server" Text="<%$ Resources:Productos_Resources, TipoRelacionGrupos_Pantalla %>" />
</asp:Content>
        ...
        <ContentTemplate>
            <table class="Container" cellspacing="0" cellpadding="0" border="0">
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="tbx_NombreTipoRelacion_Grupos" runat="server"></asp:TextBox>
                    </td>
                    <td>
