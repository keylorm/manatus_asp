<%@ Page Language="VB" MasterPageFile="../OrbeCatalog.master" AutoEventWireup="false"
    CodeFile="Grupo_Producto.aspx.vb" Inherits="_Grupo" Title="Orbe Catalog - Grupos" %>

<asp:Content ID="ctn_TituloSeccion" ContentPlaceHolderID="cph_Titulo" runat="Server">
    <asp:Literal runat="server" Text="<%$ Resources:Productos_Resources, Grupos_Pantalla %>" />
</asp:Content>
        ...
        <ContentTemplate>
            <table class="Container" cellspacing="0" cellpadding="0" border="0">
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="tbx_NombreGrupo" runat="server"></asp:TextBox>
                    </td>
                    <td>
...
<asp:Content ID="cph_Busqueda" ContentPlaceHolderID="cph_ColumnaDerecha" runat="Server">
    ...
    <asp:UpdatePanel ID="upd_Busqueda" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <div class="Container">
                <asp:TreeView ID="trv_Grupos_Productos" runat="server">
                </asp:TreeView>
            </div>
        </ContentTemplate>
    </asp:UpdatePanel>
