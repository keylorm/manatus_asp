...
Partial Class Orbecatalog_Productos
    ...
    Protected Sub btn_salvar_Click(ByVal Sender As Object, ByVal E As System.EventArgs) Handles btn_salvar.Click
        ...
        Else
            ...
            If IsValid Then
                ...
                End If
            Else
                MyMaster.MostrarMensaje("Algun campo necesario está vacio o erroneo.", True)
            End If
        End If
    End Sub
    ...
    Protected Sub btn_Accion_Ayuda_Click(ByVal Sender As Object, ByVal E As System.EventArgs) Handles btn_Accion_Ayuda.Click
        MyMaster.MostrarMensaje("Puede crear y editar la información de los <b>Productos</b><br /><br />Según el <b>Tipo de Producto</b> que seleccione, se le pedirá <b>Otros Atributos</b>.<br /><br />Recuerde que debe seleccionar un <b>Origen</b>, pues esta la default.<br />", False)
    End Sub
