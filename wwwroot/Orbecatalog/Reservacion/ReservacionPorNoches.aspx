<%@ Page Language="VB" MasterPageFile="~/Orbecatalog/OrbeCatalog.master" AutoEventWireup="false"
    CodeFile="ReservacionPorNoches.aspx.vb" Inherits="Orbecatalog_Reservacion_ReservacionPorNoches"
    Title="Reservación Por Noches" %>
                            ...
                            <ContentTemplate>
                                <div id="div_productos" runat="server">
                                    <table class="Container" cellspacing="0" cellpadding="0" border="0">
                                        <tr>
                                            <td style="width: 25%">
                                                <asp:Literal ID="Literal1" runat="server" Text="<%$ Resources:Productos_Resources, Producto %>"></asp:Literal>
                                            </td>
                                            <td style="width: 75%">
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Literal ID="Literal4" runat="server" Text="<%$ Resources:Productos_Resources, Producto_Descripcion %>"></asp:Literal>
                                            </td>
                                            <td>
                                ...
                                <table class="Container" cellspacing="0" cellpadding="0" border="0">
                                    <tr>
                                        ...
                                        <td style="width: 75%">
                                            ...
                                            <asp:HyperLink ID="Hyl_AgregarEntidad" ToolTip="Ingresar nueva entidad" ImageUrl="../iconos/agregar_small.png"
                                                runat="server"></asp:HyperLink>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <asp:HyperLink ID="Hyl_AgregarUbicacion" ToolTip="Ingresar nueva ubicación" ImageUrl="../iconos/agregar_small.png"
                                                runat="server"></asp:HyperLink>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <obout:Calendar ID="CalendarInicio" runat="server" DatePickerMode="true" TextBoxId="bdp_FechaInicio"
                                                DatePickerImagePath="../iconos/calendar.gif" AutoPostBack="false" />
                                            <asp:DropDownList ID="ddl_horaInicio" runat="server" Width="45px" Enabled="false">
                                            </asp:DropDownList>
                                            <asp:Literal runat="server" Text="<%$ Resources:Reservaciones_Resources, Hora %>"></asp:Literal>
                                            <asp:DropDownList ID="ddl_minutoInicio" runat="server" Width="45px" Enabled="false">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <asp:DropDownList ID="ddl_horaFinal" runat="server" Width="45px" Enabled="false">
                                            </asp:DropDownList>
                                            <asp:Literal runat="server" Text="<%$ Resources:Reservaciones_Resources, Hora %>"></asp:Literal>
                                            <asp:DropDownList ID="ddl_minutoFinal" runat="server" Width="45px" Enabled="false">
                                                <asp:ListItem Value="0">00</asp:ListItem>
                                                <asp:ListItem Value="5">05</asp:ListItem>
                                                <asp:ListItem>10</asp:ListItem>
                                                <asp:ListItem>15</asp:ListItem>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="botonesAcciones" style="padding-left: 100px">
                                                <br />
                                                <orbelink:ActionButton ID="btn_buscar" Text="<%$ Resources:Reservaciones_Resources, Buscar %>"
                                                    runat="server" />
                                                <orbelink:ActionButton ID="btn_cancelarB" Text="<%$ Resources:Orbecatalog_Resources, Cancelar %>"
                                                    runat="server" />
                                ...
                                <div id="div_ResultadosBusqueda" visible="False" runat="server" style="padding-top: 20px">
                                    ...
                                    <asp:GridView ID="gv_ResultadosDisponibles" runat="server" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="<%$ Resources:Reservaciones_Resources, Reservacion_AdultosConNinos %> ">
                                                <ItemTemplate>
                                                    <asp:DropDownList ID="ddl_cantidadPersonas" runat="server">
                                                    </asp:DropDownList>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="<%$ Resources:Reservaciones_Resources, Reservacion_Ninos %>">
                                                <ItemTemplate>
                                                    <asp:DropDownList ID="ddl_cantidadNinos" runat="server">
                                                    </asp:DropDownList>
                                                </ItemTemplate>
                                            </asp:TemplateField>
