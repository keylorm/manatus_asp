<%@ Page Language="VB" MasterPageFile="../OrbeCatalog.master" AutoEventWireup="false"
    CodeFile="TipoComunicacion.aspx.vb" Inherits="Orbecatalog_Bitacora_TipoComunicacion"
    Title="OrbeCatalog - Bitacora - Tipo Comunicacion" %>

<asp:Content ID="ctn_TituloSeccion" ContentPlaceHolderID="cph_Titulo" runat="Server">
    Manejo de Tipos de Comunicacion
</asp:Content>
<asp:Content ID="ctn_Contenido" ContentPlaceHolderID="cph_Contenido" runat="Server">
    <h1>
        Tipo de Comunicacion</h1>
        ...
        <ContentTemplate>
            <table class="Container" cellspacing="0" cellpadding="0" border="0">
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="tbx_NombreTipoComunicacion" runat="server"></asp:TextBox>
                    </td>
                    <td>
                        <asp:RequiredFieldValidator ID="vld_Nombre" runat="server" ControlToValidate="tbx_NombreTipoComunicacion"
...
<asp:Content ID="cph_Busqueda" ContentPlaceHolderID="cph_ColumnaDerecha" runat="Server">
    <h1>
        Comunicacions Actuales</h1>
    <asp:UpdatePanel ID="upd_Busqueda" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <div class="Container">
                <asp:DataGrid ID="dg_TipoComunicacion" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="Tipo Comunicacion">
                            <ItemTemplate>
