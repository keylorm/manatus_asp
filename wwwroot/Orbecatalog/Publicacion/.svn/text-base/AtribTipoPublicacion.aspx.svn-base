<%@ Page Language="VB" MasterPageFile="~/orbecatalog/OrbeCatalog.master" AutoEventWireup="false"
    CodeFile="AtribTipoPublicacion.aspx.vb" Inherits="_Publicaciones_AtribTipoPublicacion" Title="Orbe Catalog - Atributos por Tipo Publicacion" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cph_Titulo" runat="Server">
    Manejo de Atributos por Tipo Publicacion
</asp:Content>
            ...
            <table class="Container" cellspacing="0" cellpadding="0" border="0">
                ...
                <tr>
                    <td>
                        Tipo Publicacion</td>
                    <td>
                        <asp:DropDownList ID="ddl_TipoPublicaciones" runat="server" AutoPostBack="true">
                        </asp:DropDownList></td>
                    <td>
                ...
                <tr>
                    <td colspan="2">
                        <asp:DataGrid ID="dg_Atributos_Para_Publicaciones" runat="server" AutoGenerateColumns="False"
...
<asp:Content ID="cph_Busqueda" ContentPlaceHolderID="cph_ColumnaDerecha" runat="Server">
    ...
    <div class="Container">
        ...
        <asp:UpdatePanel ID="upd_Busqueda" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <asp:DataGrid ID="dg_MaestroAtributos_Para_Publicaciones" runat="server" AutoGenerateColumns="False"
