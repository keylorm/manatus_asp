...
Partial Class orbecatalog_Facturas_Factura
    ...
    Private Sub AgregaAtributosBotones()
        btn_Eliminar.Attributes.Add("onclick", "return confirm('Está seguro de que desea eliminar esta factura?');")
        btn_Modificar.Attributes.Add("onclick", "return confirm('Está seguro de que desea modificar la información de esta factura o Producto?');")
    ...
    ''' <summary>
    ''' Método llamado ante cualquier evento del datagrid, en este caso, los botones de 
    ...
    ''' <summary>
    ''' Agrega la confirmación de borrar al botón de "Eliminar" en el datagrid de
    ...
    Sub DG_DetalleFactura_ItemDataBound(ByVal sender As Object, ByVal e As DataGridItemEventArgs) Handles DG_DetalleFactura.ItemDataBound
        If e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem Then
            ...
            If Not btn Is Nothing Then
                btn.Attributes.Add("onclick", "return confirm('Está seguro que desea eliminar este Producto de la factura?');")
            End If
        End If
    End Sub
