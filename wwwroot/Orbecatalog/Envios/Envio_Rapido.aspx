<%@ Page Language="VB" MasterPageFile="../OrbeCatalog.master" AutoEventWireup="false"
    CodeFile="Envio_Rapido.aspx.vb" Inherits="_Envio_Rapido" Title="Orbe Catalog - Envio Rapido" %>
    ...
    <table class="Container" cellspacing="0" cellpadding="0" border="0" width="100%">
        ...
        <tr>
            <td>
                Nombre</td>
            <td>
                <asp:TextBox ID="tbx_upl_NombreEntidad" runat="server" Width="25px"></asp:TextBox></td>
            <td>
            </td>
        </tr>
        <tr>
            <td>
                Primer Apellido</td>
            <td>
                <asp:TextBox ID="tbx_upl_Apellido" runat="server" Width="25px"></asp:TextBox></td>
            <td>
            </td>
        </tr>
        <tr>
            <td>
                Segundo Apellido</td>
            <td>
                <asp:TextBox ID="tbx_upl_Apellido2" runat="server" Width="25px"></asp:TextBox></td>
            <td>
            </td>
        </tr>
        <tr>
            <td>
                Email</td>
            <td>
                <asp:TextBox ID="tbx_upl_Email" runat="server" Width="25px"></asp:TextBox></td>
            <td>
            </td>
        </tr>
    </table>
    ...
    <table class="Container" cellspacing="0" cellpadding="0" border="0" width="100%">
        <tr>
            <td style="width: 25%;">
                Archivo</td>
            <td style="width: 70%;">
                <asp:FileUpload ID="upl_ArchivoCorreo" runat="server" />
            </td>
            <td style="width: 5%">
            </td>
        </tr>
