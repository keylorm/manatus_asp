...
Partial Class Control_Relaciones_Entidad_Producto
    ...
    Public Sub cargarRelacionados(ByVal id_entidad As Integer)
        ...
        If securityHandler.verificarAcceso("Re-02") Then
            Me.hyl_agregarRelProducto.NavigateUrl = MyMaster.obtenerIframeString("../Relaciones/Entidad_Producto.aspx?id_entidad=" & id_entidad)
            Me.hyl_agregarRelProducto.Visible = True
        End If
        ...
        Producto_Entidad.id_entidad.Where.EqualCondition(id_entidad)
        ...
        If dataSet.Tables.Count > 0 Then
            If dataSet.Tables(0).Rows.Count > 0 Then
                ...
                For counter As Integer = 0 To dataSet.Tables(0).Rows.Count - 1
                    ...
                    relacion.Text = act_tipo.Nombre_Entidad_Producto.Value & " " & act_Producto.Nombre.Value
