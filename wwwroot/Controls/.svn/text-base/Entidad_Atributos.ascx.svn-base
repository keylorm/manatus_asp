<%@ Control Language="VB" AutoEventWireup="false" CodeFile="Entidad_Atributos.ascx.vb"
    Inherits="Controls_Entidad_Atributos" %>
                ...
                <td colspan="3">
                    <asp:DataGrid ID="dg_Atributos" runat="server" AutoGenerateColumns="False" CellPadding="0"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn>
                                <ItemTemplate>
                                    <asp:Image ID="img_Info" runat="server" ImageUrl="~/Orbecatalog/images/icons/info.gif" />
                                </ItemTemplate>
                                <ItemStyle Width="5%" />
                            </asp:TemplateColumn>
