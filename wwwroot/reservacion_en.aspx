        ...
        <div class="content container-980">
                ...
                <asp:UpdatePanel ID="updtpanel_reservacion" runat="server">
                    <ContentTemplate>
                        ...
                        <div class="headerReservation">
                            <h2>
                                MAKE your reservation TODAY</h2>
                        </div>
                        <div>
                            <div class="fondoGrisReserva">
                                <div class="paddingReserva">
                                    <asp:Panel ID="panel" runat="server" Visible="true">
                                        ...
                                        <asp:Panel ID="pnl_contenido" runat="server" Visible="true">
                                            <div style="display: none;">
                                                <asp:Label ID="lbl_nombre" runat="server" Text="Nombre:"></asp:Label></div>
                                            ...
                                            <div style="display: none;">
                                                <asp:Label ID="lbl_dir" runat="server" Text="Dirección:"></asp:Label></div>
                                            ...
                                            <div style="display: none;">
                                                <asp:Label ID="lbl_ubicacion" runat="server" Text="País:"></asp:Label></div>
                                            <div class="box-ubicacion">
                                                <asp:DropDownList ID="ddl_ubicacion" runat="server" CssClass="dropdownsReserva">
                                                </asp:DropDownList>
                                            </div>
                                            <div style="display: none;">
                                                <asp:Label ID="lbl_codigoA" runat="server" Text="Código de Area:"></asp:Label></div>
                                            ...
                                            <asp:RequiredFieldValidator ID="rfv_codigoA" runat="server" ControlToValidate="txt_codArea"
                                                Display="Dynamic" ErrorMessage="Campo requerido" ValidationGroup="registrese"></asp:RequiredFieldValidator>
                                            <div style="display: none;">
                                                <asp:Label ID="lbl_telefono" runat="server" Text="Teléfono:"></asp:Label></div>
                                            ...
                                            <asp:RequiredFieldValidator ID="rfv_Tel" runat="server" ControlToValidate="txt_tel"
                                                Display="Dynamic" ErrorMessage="Campo requerido" ValidationGroup="registrese"></asp:RequiredFieldValidator>
                                            <div style="display: none;">
                                                <asp:Label ID="lbl_email" runat="server" Text="  Email:"></asp:Label></div>
                                            ...
                                            <div style="display: none;">
                                                <asp:Label ID="lbl_fechaE" runat="server" Text="Fecha de Entrada:"></asp:Label></div>
                                            <div style="width: 100%; display: block;">
                                                ...
                                                <%-- --%>
                                                <div style="display: none;">
                                                    <asp:Label ID="lbl_fechaS" runat="server" Text="Fecha de Salida:"></asp:Label></div>
                                            ...
                                            <div style="display: none;">
                                                <asp:Label runat="server" ID="lbl_noches" Text="La 3er y 4ta noche son en Manatus"
                                                    Visible="false">
                                                </asp:Label></div>
                                            <div id="traslado-box">
                                                <p>
                                                            ...
                                                            <asp:TemplateField HeaderText="Personas" HeaderStyle-HorizontalAlign="Right">
                                                                <ItemTemplate>
                                                                    ...
                                                                    <div class="box-select-personas">
                                                                        <asp:DropDownList ID="ddl_personas" CssClass="dropdownsReserva" runat="server">
                                            ...
                                            <div style="display: none;">
                                                <asp:Label ID="lbl_observaciones" runat="server" Text="Observaciones:"></asp:Label></div>
                                    ...
                                    <br />
                                    <p class="link-chat">
                                        * If you have questions please do not hesitate to contact us through our <span class="colorRojo">
                                            <a href="javascript: $zopim.livechat.window.show();">CHAT</a></span><br />
                                        ** Service subject to availability. Guests must contact Manatus Hotel in order to
                                        establish the pick up or drop off place.<br />
                                        <br />
                                        Cost per person per transfer per way: $75<br />
                                        <!--Cost per person per transfer per way 2015: $75<br />-->
                                        <br />
                                    </p>
                                    <br />
                                    <br />
            ...
            <div class="sidebar">
                <div class="paddingBottomp10">
                    ...
                    <br />
                    <h3 class="chat">
                        <a href="javascript:%20$zopim.livechat.window.show();">CHAT WITH US</a></h3>
                </div>
                <ul class="menu-sidebar">
                    <li class="first leaf virtual-tours mid-959"><a title="" href="http://manatuscostarica.com/virtual-tours/garden">
                        Virtual Tours</a></li>
                    <li class="leaf photo-video-gallery mid-961"><a title="" href="http://manatuscostarica.com/gallery">
                        Photo &amp; Video Gallery</a></li>
                    <li class="last leaf from-our-blog mid-963"><a title="" href="http://manatuscostarica.com/blog">
                        From our Blog</a></li>
                </ul>
            </div>
        </div>
