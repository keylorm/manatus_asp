...
Partial Class shoppingCar_sp
    ...
    Protected Sub btn_pagar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_pagar.Click
        Orbelink.DBHandler.LanguageHandler.CurrentLanguage = Orbelink.DBHandler.LanguageHandler.Language.ESPANOL
        Session("id_reservacion") = lbl_term.Text
        Response.Redirect("checkout.aspx", False) '"BNCR/IntermediaBNCR.aspx", False)
    ...
    Protected Sub btn_cancelar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_cancelar.Click
        ...
        Response.Redirect("Reservacion_sp.aspx")
    End Sub
    ...
    Protected Sub btn_cancelar_arriba_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_cancelar_arriba.Click
        Dim controladoraReservaciones As New Orbelink.Control.Reservaciones.ControladorReservaciones(connection, Resources.Reservaciones_Resources.ResourceManager)
        controladoraReservaciones.NuevoEstadoParaReservacion(lbl_term.Text, ControladorReservaciones.Config_EstadoIncompleto, ControladorReservaciones.Config_VendedorDefault, "Cancelada en Paso 1", True)
        Response.Redirect("Reservacion_sp.aspx")
    End Sub
